...
var RegisterUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var salt, hashedPassword, newUser, err_1;
...
var Login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var User, validated, token, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 3:
                ...
                token = jsonwebtoken_1.default.sign({ id: User === null || User === void 0 ? void 0 : User._id, isAdmin: User === null || User === void 0 ? void 0 : User.isAdmin }, process.env.SECRET_KEY, { expiresIn: "5d" });
