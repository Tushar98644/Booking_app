...
var UpdateUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                if (!((user === null || user === void 0 ? void 0 : user._id) === req.body.userId)) return [3 /*break*/, 3];
                return [4 /*yield*/, (user === null || user === void 0 ? void 0 : user.updateOne({ $set: req.body }))];
            case 2:
                _a.sent();
...
var DeleteUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                if (!((user === null || user === void 0 ? void 0 : user._id) === req.body.d)) return [3 /*break*/, 3];
                return [4 /*yield*/, (user === null || user === void 0 ? void 0 : user.deleteOne())];
            case 2:
                _a.sent();
